...
class Solution:
    def decoder(self,id):
        ...
        for x in range(len(temp2)):
            if temp2[x] != "0" and bing == False:
                temp = x
                bing = True
                #print(bing, temp2[temp])
            elif temp2[x] == "0" and x > temp and bing2 == False:
                last_name = temp2[temp:x]
                bing2 = True
            if temp2[x] == "1" or temp2[x] == "2" or temp2[x] == "3" or temp2[x] == "4" or temp2[x] == "5" or temp2[x] == "6" or temp2[x] == "7" or temp2[x] == "8" or temp2[x] == "9":
                ID = temp2[x:]
                if last_name == "":
                    last_name = temp2[temp:x]
                break
        final_string = "First name = " + first_name + ", Last name = " + last_name + ", id = " + str(ID)
        return final_string
def main():
    string1 = input()
